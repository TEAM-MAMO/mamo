  ...
  args: {
    children: (
      <>
        ...
        <br />
        <Text level={1}>Text 1 마모가 여러분의 마음을 소중하게 전달하고 있어요</Text>
        <Text level={2}>Text 2 마모가 여러분의 마음을 소중하게 전달하고 있어요</Text>
        <Text level={3}>Text 3 마모가 여러분의 마음을 소중하게 전달하고 있어요</Text>
        ...
        <br />
        <Foot level={1}>Foot 1 마모가 여러분의 마음을 소중하게 전달하고 있어요</Foot>
        <Foot level={2}>Foot 2 마모가 여러분의 마음을 소중하게 전달하고 있어요</Foot>
        <Foot level={3}>Foot 3 마모가 여러분의 마음을 소중하게 전달하고 있어요</Foot>
      </>
    ),
  },
};
